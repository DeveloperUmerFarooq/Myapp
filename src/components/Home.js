    ...
    <div className='container-fluid text-center fs-1 pt-5' id='Home' >
      <div className='row flex-lg-row-reverse p-5 pb-0 mb-sm-5 mt-lg-5 text-light text-start'>
        ...
        <div className='col-lg align-content-lg-center' id='Intro'>
          <h1 className='pb-0 fs-1'>Muhammad Umer Farooq</h1>
          <p className=' d-inline fs-3 text-light'>I am currently <span className='text-info' style={{ fontWeight: 'bold' }}>
            ...
            <br></br></p>
          <p className='d-inline fs-4 text-success fw-bold '> <span style={{ color: '#a7c957', fontWeight: 'bold' }}>
            {/* Style will be inherited from the parent element */}
            <Typewriter
