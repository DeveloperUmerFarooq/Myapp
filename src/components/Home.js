        ...
        <div className='container'>
          <div className='row'>
            {images.map((image, index) => (
              <div key={index} className='flex-column fs-5 col-lg-1 col-md-3 col-sm-1 pt-4 align-content-center justify-content-center tech' data-aos="fade-up" data-aos-delay={(window.innerWidth>1000?index * 250:(index/3)*300)}>
